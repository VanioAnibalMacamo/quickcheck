              ...
              <form action="{{url('updateArea',$area->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nome" name='nome' value="{{ $area->nome }}" placeholder="Digite o nome da Área...">
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                        <label for="inputEmail4">Descrição</label>
                        <input type="text" class="form-control" id="descricao" name='descricao' value="{{ $area->descricao }}"  placeholder="Digite a descrição da Área...">
                        </div>
                        <div class="form-group col-md-6">
